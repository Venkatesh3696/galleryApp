...
class Gallery extends Component {
  ...
  render() {
    ...
    console.log(`current id : ${activeImageId}`)
    const activeImageDetails = imagesList[activeImageId]
    console.log({activeImageDetails})
    const {imageUrl, imageAltText} = activeImageDetails
    return (
      <div className="main-container">
        <img alt={imageAltText} src={imageUrl} className="main-image" />
